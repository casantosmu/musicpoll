    ...
    return (
        <>
            <div className="border-b pb-6">
                <h1 className="text-3xl font-bold text-gray-100">Terms and Conditions</h1>
            ...
            <div className="prose max-w-none text-gray-200">
                ...
                <section className="mb-10">
                    <h2 className="text-2xl font-bold text-gray-200 mb-4 border-b pb-2 border-gray-200">
                        Interpretation and Definitions
                    </h2>

                    <h3 className="text-xl font-semibold text-gray-200 mt-6 mb-3">Interpretation</h3>
                    ...
                    <h3 className="text-xl font-semibold text-gray-200 mt-6 mb-3">Definitions</h3>
                    <p className="text-gray-300 mb-4">For the purposes of these Terms and Conditions:</p>
                    ...
                    <ul className="list-disc pl-6 space-y-3 text-gray-300">
                        <li>
                            <p>
                                ...
                                of 50% or more of the shares, equity interest or other securities entitled to vote for
                                election of directors or other managing authority.
                            </p>
                        </li>
                        <li>
                            <p>
                                <strong className="font-semibold">Country</strong> refers to: Spain
                            </p>
                        </li>
                        <li>
                            <p>
                                <strong className="font-semibold">Company</strong> (referred to as either "the Company",
                                "We", "Us" or "Our" in this Agreement) refers to MusicPoll.
                            </p>
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            <p>
                                <strong className="font-semibold">Terms and Conditions</strong> (also referred as
                                "Terms") mean these Terms and Conditions that form the entire agreement between You and
                                the Company regarding the use of the Service.
                            </p>
                        </li>
                        <li>
                            <p>
                                <strong className="font-semibold">Third-party Social Media Service</strong> means any
                        ...
                        <li>
                            <p>
                                <strong className="font-semibold">Website</strong> refers to MusicPoll, accessible from{" "}
                                <a
                        ...
                        <li>
                            <p>
                                <strong className="font-semibold">You</strong> means the individual accessing or using
                ...
                <section className="mb-10">
                    <h2 className="text-2xl font-bold text-gray-200 mb-4 border-b pb-2 border-gray-200">Termination</h2>
                    <div className="space-y-4 text-gray-300">
                        <p>
                ...
                <section className="mb-10">
                    ...
                    <h3 className="text-xl font-semibold text-gray-200 mt-6 mb-3">Severability</h3>
                    <p className="text-gray-300 mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-gray-200 mt-6 mb-3">Waiver</h3>
                    <p className="text-gray-300 mb-4">
                ...
                <section className="mb-6">
                    <h2 className="text-2xl font-bold text-gray-200 mb-4 border-b pb-2 border-gray-200">Contact Us</h2>
                    <div className="space-y-4 text-gray-300">
                        <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
                        <ul className="list-disc pl-6">
                            <li>
                                By email:{" "}
                                <a href="mailto:contact@musicpoll.net" className="text-green-500 hover:text-green-400">
