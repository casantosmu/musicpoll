    ...
    return (
        <>
            ...
            <div className="prose max-w-none text-gray-200">
                ...
                <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-100">Interpretation and Definitions</h2>

                <h3 className="text-xl font-medium mt-6 mb-3 text-gray-100">Interpretation</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-medium mt-6 mb-3 text-gray-100">Definitions</h3>
                <p className="mb-2">For the purposes of this Privacy Policy:</p>

                <ul className="list-disc pl-6 space-y-2 mb-6">
                    <li>
                        <p>
                            <strong className="font-medium">Account</strong> means a unique account created for You to
                            access our Service or parts of our Service.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong className="font-medium">Affiliate</strong> means an entity that controls, is
                            controlled by or is under common control with a party, where &quot;control&quot; means
                            ownership of 50% or more of the shares, equity interest or other securities entitled to vote
                            for election of directors or other managing authority.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong className="font-medium">Company</strong> (referred to as either &quot;the
                    ...
                    <li>
                        <p>
                            <strong className="font-medium">Cookies</strong> are small files that are placed on Your
                    ...
                    <li>
                        <p>
                            <strong className="font-medium">Country</strong> refers to: Spain
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong className="font-medium">Device</strong> means any device that can access the Service
                            such as a computer, a cellphone or a digital tablet.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong className="font-medium">Personal Data</strong> is any information that relates to an
                            identified or identifiable individual.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong className="font-medium">Service</strong> refers to the Website.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong className="font-medium">Service Provider</strong> means any natural or legal person
                    ...
                    <li>
                        <p>
                            <strong className="font-medium">Third-party Social Media Service</strong> refers to any
                            website or any social network website through which a User can log in or create an account
                            to use the Service.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong className="font-medium">Usage Data</strong> refers to data collected automatically,
                    ...
                    <li>
                        <p>
                            <strong className="font-medium">Website</strong> refers to MusicPoll, accessible from{" "}
                            <a
                                className="text-green-500 hover:text-green-400"
                                href="https://musicpoll.net/"
                    ...
                    <li>
                        <p>
                            <strong className="font-medium">You</strong> means the individual accessing or using the
                ...
                <h3 className="text-xl font-medium mt-6 mb-3 text-gray-100">Types of Data Collected</h3>

                <h4 className="text-lg font-medium mt-5 mb-2 text-gray-100">Personal Data</h4>
                <p className="mb-2">
                ...
                <h4 className="text-lg font-medium mt-5 mb-2 text-gray-100">Usage Data</h4>
                ...
                <h4 className="text-lg font-medium mt-5 mb-2 text-gray-100">
                ...
                <h4 className="text-lg font-medium mt-5 mb-2 text-gray-100">Tracking Technologies and Cookies</h4>
                <p className="mb-2">
                ...
                <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>
                        <strong className="font-medium">Cookies or Browser Cookies.</strong> A cookie is a small file
                    ...
                    <li>
                        <strong className="font-medium">Web Beacons.</strong> Certain sections of our Service and our
                ...
                <ul className="list-disc pl-6 space-y-3 mb-4">
                    <li>
                        <p>
                            <strong className="font-medium">Necessary / Essential Cookies</strong>
                        </p>
                        <p className="text-sm text-gray-300">Type: Session Cookies</p>
                        <p className="text-sm text-gray-300">Administered by: Us</p>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong className="font-medium">Cookies Policy / Notice Acceptance Cookies</strong>
                        </p>
                        <p className="text-sm text-gray-300">Type: Persistent Cookies</p>
                        <p className="text-sm text-gray-300">Administered by: Us</p>
                ...
                <h3 className="text-xl font-medium mt-6 mb-3 text-gray-100">Use of Your Personal Data</h3>
                <p className="mb-2">The Company may use Personal Data for the following purposes:</p>

                <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>
                        <p>
                            <strong className="font-medium">To provide and maintain our Service</strong>, including to
                            monitor the usage of our Service.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong className="font-medium">To manage Your Account:</strong> to manage Your registration
                    ...
                    <li>
                        <p>
                            <strong className="font-medium">For the performance of a contract:</strong> the development,
                    ...
                    <li>
                        <p>
                            <strong className="font-medium">To contact You:</strong> To contact You by email, telephone
                    ...
                    <li>
                        <p>
                            <strong className="font-medium">To provide You</strong> with news, special offers and
                    ...
                    <li>
                        <p>
                            <strong className="font-medium">To manage Your requests:</strong> To attend and manage Your
                            requests to Us.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong className="font-medium">For business transfers:</strong> We may use Your information
                    ...
                    <li>
                        <p>
                            <strong className="font-medium">For other purposes</strong>: We may use Your information for
                ...
                <ul className="list-disc pl-6 space-y-2 mb-6">
                    <li>
                        <strong className="font-medium">With Service Providers:</strong> We may share Your personal
                        information with Service Providers to monitor and analyze the use of our Service, to contact
                        You.
                    </li>
                    <li>
                        <strong className="font-medium">For business transfers:</strong> We may share or transfer Your
                        personal information in connection with, or during negotiations of, any merger, sale of Company
                        assets, financing, or acquisition of all or a portion of Our business to another company.
                    </li>
                    <li>
                        <strong className="font-medium">With Affiliates:</strong> We may share Your information with Our
                    ...
                    <li>
                        <strong className="font-medium">With business partners:</strong> We may share Your information
                        with Our business partners to offer You certain products, services or promotions.
                    </li>
                    <li>
                        <strong className="font-medium">With other users:</strong> when You share personal information
                        or otherwise interact in the public areas with other users, such information may be viewed by
                        all users and may be publicly distributed outside. If You interact with other users or register
                    ...
                    <li>
                        <strong className="font-medium">With Your consent</strong>: We may disclose Your personal
                        information for any other purpose with Your consent.
                    </li>
                </ul>

                <h3 className="text-xl font-medium mt-6 mb-3 text-gray-100">Retention of Your Personal Data</h3>
                <p className="mb-2">
                ...
                <h3 className="text-xl font-medium mt-6 mb-3 text-gray-100">Transfer of Your Personal Data</h3>
                <p className="mb-2">
                ...
                <h3 className="text-xl font-medium mt-6 mb-3 text-gray-100">Delete Your Personal Data</h3>
                <p className="mb-2">
                ...
                <h3 className="text-xl font-medium mt-6 mb-3 text-gray-100">Disclosure of Your Personal Data</h3>

                <h4 className="text-lg font-medium mt-5 mb-2 text-gray-100">Business Transactions</h4>
                <p className="mb-4">
                ...
                <h4 className="text-lg font-medium mt-5 mb-2 text-gray-100">Law enforcement</h4>
                <p className="mb-4">
                ...
                <h4 className="text-lg font-medium mt-5 mb-2 text-gray-100">Other legal requirements</h4>
                <p className="mb-2">
                ...
                <h3 className="text-xl font-medium mt-6 mb-3 text-gray-100">Security of Your Personal Data</h3>
                <p className="mb-6">
                ...
                <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-100">Children's Privacy</h2>
                <p className="mb-2">
                ...
                <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-100">Links to Other Websites</h2>
                <p className="mb-2">
                ...
                <ul className="list-disc pl-6 mb-6">
                    <li>
                        By email:{" "}
                        <a className="text-green-500 hover:text-green-400" href="mailto:privacy@musicpoll.net">
                            contact@musicpoll.net
                        </a>
                    </li>
                </ul>
            </div>
